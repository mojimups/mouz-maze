...
public class Level4 extends BasePanel implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	
	//******************************************************
	static String lvlCode = "l4";
	public static String lvlNum = "Ⅳ";
	public static String lvlName = "Claustrophobia";
	static int star2 = 15;
	static int star3 = 10;
	private int xOff = -50;
	private int yOff = 25;
	...
	public Level4(){
		...
		GameFrame.frame.setFocusable(true);
			...
			gamePN.add(start);
				...
				start.setBounds(1200+xOff, 375+yOff, 30, 30);
			gamePN.add(end);
				end.addMouseListener(this);
				end.setBounds(675+xOff, 620+yOff, 30, 30);
			//******************************************************
	}
	...
	protected void paintComponent(Graphics g) {
		...
		if (ended) {
			...
			int[] x = { 705, 705, 575, 475, 350, 475, 575, 750, 875, 875,1000,1000,1125,1125,1350,1350,1200,1200,1320,1320,1155,1155, 970, 970, 905, 905, 740, 575, 475, 310, 475, 585, 675, 675};
			int[] y = { 650, 475, 475 ,575, 450, 325, 425, 250, 250, 475, 475, 300, 300, 575, 575, 375, 375, 405, 405, 545, 545, 270, 270, 445, 445, 220, 220, 385, 285, 450, 615, 505, 505, 650};
